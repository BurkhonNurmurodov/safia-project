...
/* ────────────────────────── dummy data ──────────────────────────────── */
/* Placeholder portraits. `photo` is the plain shot (round avatars crop it to
 * the face); `render` is the background-lifted cut-out the player cards stand
 * up on the plate — a real per-brigadir pair replaces these with the data. */
const TPL = {
  f: { photo: "/images/supervisors/female_template.jpg", render: "/images/supervisors/female_template_cut.png" },
  m: { photo: "/images/supervisors/male_template.jpg",   render: "/images/supervisors/male_template_cut.png" },
};

const RAW = [
  { name: "Malika Qodirova",   unit: "2-uchastka",  img: TPL.f, s: { zag: 92, naz: 88, kai: 90, xav: 84, kir: 96 } },
  { name: "Dilshod Karimov",   unit: "5-uchastka",  img: TPL.m, s: { zag: 90, naz: 92, kai: 78, xav: 88, kir: 91 } },
  { name: "Aziza Tosheva",     unit: "1-uchastka",  img: TPL.f, s: { zag: 87, naz: 74, kai: 92, xav: 90, kir: 88 } },
  { name: "Murodali Ochilov",  unit: "7-uchastka",  img: TPL.m, s: { zag: 84, naz: 81, kai: 70, xav: 76, kir: 90 } },
  { name: "Sherzod Aliyev",    unit: "3-uchastka",  img: TPL.m, s: { zag: 86, naz: 70, kai: 75, xav: 72, kir: 84 } },
  { name: "Nodira Yusupova",   unit: "4-uchastka",  img: TPL.f, s: { zag: 78, naz: 85, kai: 80, xav: 74, kir: 81 } },
  { name: "Jasur Rahimov",     unit: "9-uchastka",  img: TPL.m, s: { zag: 83, naz: 62, kai: 68, xav: 80, kir: 77 } },
  { name: "Gulnora Ismoilova", unit: "8-uchastka",  img: TPL.f, s: { zag: 71, naz: 78, kai: 74, xav: 70, kir: 79 } },
  { name: "Bekzod Tursunov",   unit: "6-uchastka",  img: TPL.m, s: { zag: 74, naz: 66, kai: null, xav: 72, kir: 76 } },
  { name: "Kamola Ergasheva",  unit: "11-uchastka", img: TPL.f, s: { zag: 69, naz: 72, kai: 60, xav: 66, kir: 74 } },
  { name: "Rustam Nazarov",    unit: "10-uchastka", img: TPL.m, s: { zag: 66, naz: 58, kai: 55, xav: 62, kir: 70 } },
  { name: "Sardor Xolmatov",   unit: "12-uchastka", img: TPL.m, s: { zag: 58, naz: 52, kai: 48, xav: 60, kir: 63 } },
];
...
function buildData(seed) {
  const sups = RAW.map((r, i) => {
    ...
    return { id: i, name: r.name, unit: r.unit, shift: unitShift(r.unit), image: r.image, color: SUP_COLORS[i], s, comp, hist, sparks, scoreDelta: +(trend * 1.6 + (rnd() - 0.5)).toFixed(1) };
  });
