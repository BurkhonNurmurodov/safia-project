...
import { cellKey, countsInLoad, CellStatusChip as StatusChip } from "../utils/cellAttendance";
...
// cellKey / countsInLoad / StatusChip live in utils/cellAttendance.jsx — the
// Staff page's cell view reads the same table and must agree on all three.
