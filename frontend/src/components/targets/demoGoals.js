...
export function buildDemoGoals(today = todayISO()) {
  ...
  return [
    {
      id: uid(), category: "production", createdAt: d(-24),
      ...
      targets: [
        {
          id: uid(), title: "Smena o'rtacha kutish", type: "number", direction: "down",
        ...
        {
          id: uid(), title: "Liderlar kutishni o'z vaqtida kiritishi", type: "percent", direction: "up",
          start: 70, current: 88, target: 95, unit: "", weight: 1, done: false, items: [],
          checkins: [ci(16, 78, "", today), ci(8, 84, "", today), ci(2, 88, "", today)],
        },
        {
          id: uid(), title: "Har bir toifaga mas'ul biriktirish", type: "boolean", direction: "up",
          start: 0, current: 0, target: 1, unit: "", weight: 1, done: true, items: [], checkins: [],
        },
      ],
    },
    {
      id: uid(), category: "quality", createdAt: d(-40),
      ...
      targets: [
        {
          id: uid(), title: "Bartaraf etilgan ulushi", type: "percent", direction: "up",
        ...
        {
          id: uid(), title: "Ochiq shikoyatlar", type: "number", direction: "down",
    ...
    {
      id: uid(), category: "people", createdAt: d(-10),
      ...
      targets: [
        {
          id: uid(), title: "O'tish bosqichlari", type: "tasks", direction: "up",
        ...
        {
          id: uid(), title: "Muddatida topshirilgan chek-listlar", type: "percent", direction: "up",
    ...
    {
      id: uid(), category: "cost", createdAt: d(-45),
      ...
      targets: [
        {
          id: uid(), title: "Oylik kutish xarajati", type: "currency", direction: "down",
    ...
    {
      id: uid(), category: "production", createdAt: d(-30),
      ...
      targets: [
        {
          id: uid(), title: "Avto-to'ldirishdagi brigadalar", type: "number", direction: "up",
    ...
    {
      id: uid(), category: "people", createdAt: d(-35),
      ...
      targets: [
        {
          id: uid(), title: "Tasdiqlangan yacheykalar", type: "percent", direction: "up",
    ...
    {
      id: uid(), category: "safety", createdAt: d(-2),
      ...
      targets: [
        {
          id: uid(), title: "Jarohatlar soni", type: "number", direction: "down",
          start: 3, current: 3, target: 0, unit: "ta", weight: 2, done: false, items: [], checkins: [],
        },
        {
          id: uid(), title: "Oylik xavfsizlik aylanishi", type: "tasks", direction: "up",
