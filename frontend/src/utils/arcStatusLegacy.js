// /arc-legacy only — the OLD login API's status vocabulary. The current /arc
// page reads integer codes through utils/arcStatus.js; never mix the two.
//
// ARC ticket status → traffic-light tone. The old ARC API ships a free-form
