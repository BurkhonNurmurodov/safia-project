...
_T = {
    ...
    "act.idle_cell.interval_added": ("Yacheykaga kutish qo'shildi",
                                     "Ячейкага кутиш қўшилди",
                                     "Добавлено ожидание по ячейке",
                                     "Per-cell ojidaniya added"),
    "act.idle_cell.interval_edited": ("Yacheyka kutishi tahrirlandi",
                                      "Ячейка кутиши таҳрирланди",
                                      "Изменено ожидание по ячейке",
                                      "Per-cell ojidaniya edited"),
    "act.idle_cell.interval_deleted": ("Yacheyka kutishi o'chirildi",
                                       "Ячейка кутиши ўчирилди",
                                       "Удалено ожидание по ячейке",
                                       "Per-cell ojidaniya deleted"),
    "act.idle_cell.interval_decided": ("Yacheyka kutish so'rovi hal qilindi",
                                       "Ячейка кутиш сўрови ҳал қилинди",
                                       "Решён запрос на ожидание по ячейке",
                                       "Per-cell ojidaniya request decided"),
    "act.idle_cell.peren_saved": ("Yacheyka bo'yicha perenaladka kiritildi",
                                  "Ячейка бўйича переналадка киритилди",
                                  "Внесена переналадка по ячейке",
                                  "Per-cell changeover entered"),
    "act.idle_cell.peren_deleted": ("Yacheyka bo'yicha perenaladka yozuvi o'chirildi",
