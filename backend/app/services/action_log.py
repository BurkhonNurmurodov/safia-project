...
_R: list[tuple[Optional[tuple[str, ...]], str, str, str]] = [
    ...
    (("POST",),   "/api/leaders/late-proofs/{}/undo",         "leader_review", "late_proof.undone"),
    # The appeal chat (2026-09-26): one conversation per objection / late proof.
    (("POST",),   "/api/leaders/disputes/{}/messages",        "leader_review", "dispute.message"),
    (("PUT",),    "/api/leaders/disputes/{}/messages/{}",     "leader_review", "dispute.message_edited"),
    (("DELETE",), "/api/leaders/disputes/{}/messages/{}",     "leader_review", "dispute.message_deleted"),
    ...
    (("POST",),   "/api/arc-legacy/export.xlsx",               "sync_export", "export.arc_legacy"),
    ...
    # person's post.
    (("PUT",),    "/api/idle-owner/admin/owners",              "config", "config.idle_owner_saved"),
    (("PUT",),    "/api/downtime/wage-rates",                  "config", "config.wage_rate_saved"),
