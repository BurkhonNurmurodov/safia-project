...
L = {
    ...
    "uz_cyrl": {
        ...
        "act_done": "Ҳафталик свод эълон қилинди",
    ...
    "ru": {
        ...
        "d_days": "дней", "d_brigs": "бригадиров", "d_reps": "отчётов",
        ...
        "ns_total": "Итого «не остановившие»",
        "soat": "ч", "daq": "мин",
        ...
        "rest_summary": "Остальные {n} бригадиров",
        "insight": "Главная причина потерь — «{label}» (<code>{code}</code>): {v} минут, {p} всех ожиданий. Самый тяжёлый день — {d}, {wd}: {dv} минут.",
        "cite": "Страница «Ожидания», {range}",
        "sec_actions": "На следующую неделю",
        "act_cat": "«{label}» (<code>{code}</code>) — меры по ячейкам: {names}",
        ...
        "m1": "Числа взяты из половины сменного отчёта «ячейка остановлена».",
